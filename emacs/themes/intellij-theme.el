...
(custom-theme-set-faces
 'intellij
 '(default ((t (:inherit nil :stipple nil :background "#f5f5f5" :foreground "#000000"
 ...
 '(mode-line ((t (:weight normal :slant normal :underline nil :box nil :inverse-video t :foreground "#5974ab" :background "#ffffff"))))
