...
(let* ((class '((class color) (min-colors 89)))
       ...
       (yellow "#eac988") ;; tab-control-dirty-tab-close-button
       (aqua "#8bbeeb") ;; lighter complement tab-control-dirty-tab-close-button
       (blue "#89AAEB") ;; complement tab-control-dirty-tab-close-button
       (purple "#b48ead")) ;; complement tab-control-dirty-tab-close-button
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((,class (:foreground ,"#8fa1b3"))))
   ...
   ;; Elixir
   `(elixir-atom-face ((,class (:foreground ,green))))
...
;;; spacegray-ocean-theme.el ends here
