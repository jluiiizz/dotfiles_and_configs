...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
    ...
    `(font-lock-comment-delimiter-face    ((,class (:foreground ,dp_green  ))))
    `(font-lock-comment-face              ((,class (:foreground ,dp_green  ))))
    `(font-lock-constant-face             ((,class (:foreground ,dp_bright_blue  ))))
    `(font-lock-doc-face                  ((,class (:foreground ,comment  ))))
    `(font-lock-function-name-face        ((,class (:foreground ,func     ))))
    `(font-lock-keyword-face              ((,class (:foreground ,dp_dark_blue))))
    ...
    `(font-lock-type-face                 ((,class (:foreground ,dp_dark_blue     ))))
    ...
    `(minibuffer-prompt        ((,class (:foreground ,dp_light_blue                    ))))
